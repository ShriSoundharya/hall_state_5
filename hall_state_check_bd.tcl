...
################################################################
# This is a generated script based on design: hall_state_check
#
...
# source hall_state_check_script.tcl
...
set design_name hall_state_check
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Hall_U [ create_bd_port -dir I Hall_U ]
  set Hall_V [ create_bd_port -dir I Hall_V ]
  set Hall_W [ create_bd_port -dir I Hall_W ]
  set hall_state [ create_bd_port -dir O -from 2 -to 0 hall_state ]
  set state_change_flag [ create_bd_port -dir O state_change_flag ]
  ...
  # Create instance: read_feedback_0, and set properties
  set block_name read_feedback
  set block_cell_name read_feedback_0
  if { [catch {set read_feedback_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $read_feedback_0 eq "" } {
  ...
  connect_bd_net -net Hall_U_1 [get_bd_ports Hall_U] [get_bd_pins read_feedback_0/input_1]
  connect_bd_net -net Hall_V_1 [get_bd_ports Hall_V] [get_bd_pins read_feedback_0/input_2]
  connect_bd_net -net Hall_W_1 [get_bd_ports Hall_W] [get_bd_pins read_feedback_0/input_3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins read_feedback_0/clk]
  connect_bd_net -net read_feedback_0_hall_state [get_bd_ports hall_state] [get_bd_pins read_feedback_0/hall_state]
  connect_bd_net -net read_feedback_0_state_change_flag [get_bd_ports state_change_flag] [get_bd_pins read_feedback_0/state_change_flag]
